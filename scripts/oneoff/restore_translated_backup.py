# One-off repair script for the "frieren" book: restores translated manga
# page images from a backup EPUB into books/frieren/translated. Not a
# reusable tool -- paths are hardcoded to this specific book.
import os
import re
import zipfile
import shutil
